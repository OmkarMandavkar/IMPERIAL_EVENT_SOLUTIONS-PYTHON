...
filename = PhotoImage(file = r"G:\VSCode\Python-Project\x3.png")
...
def pay():
    ...
    mycanvas.create_text(320,20 ,text = adv  , fill="black",font=("times new roman", 16,"bold"))
...
btn3=Button(window, text="Back", fg='black', font=("Times New Roman", 12,"bold"),command=back)  #clear
